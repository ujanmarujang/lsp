...
Route::get('/peserta/{peserta}/pdf', [PesertaPdfController::class, 'generatePdf'])->name('peserta.pdf');Route::get('/peserta', [PesertaPdfController::class, 'index'])->name('peserta.index');
